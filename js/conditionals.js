...
//     } switch(color) {
//         case "red":
//             return "red is passionate"
//         default:
//             return color + " is not my favorite color"
//
//     }
// }
// console.log(analyzeColor("blue"));
...
// alert('Your lucky number was: ' +luckyNumber+ '. Your total before the discount was $' +billTotal+ '. Your total after the discount was applied is: $' +discountTotal)
...
//adds 100 to number + alert

var plusHundred = function (num) {
    var added = num + 10
    alert(num + " plus 100 equals " + added)
}
...
//Ask user if they want to enter a number and save response as boolean
